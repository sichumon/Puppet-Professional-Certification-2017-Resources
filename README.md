# Puppet-Professional-Certification-2017-Resources
Online resources that will help you prepare for taking the Puppet Professional 2017 Certification exam.

## Exam Objectives

These are the exam objectives you review and understand.
...
* [Hiera 1: Overview](http://docs.puppetlabs.com/hiera/3.0/)
* [Hiera 1: installation](http://docs.puppetlabs.com/hiera/3.0/installing.html)
* [Configuration and hiera.yaml](https://docs.puppetlabs.com/hiera/3.0/configuring.html)
* [Hierachies](https://docs.puppetlabs.com/hiera/3.0/hierarchy.html)
* [Lookup Types](https://docs.puppetlabs.com/hiera/3.0/lookup_types.html)
* [Writing Data Sources](https://docs.puppetlabs.com/hiera/3.0/data_sources.html)
* [Interpolation Tokesn, Variables and Lookup Functions](https://docs.puppetlabs.com/hiera/3.0/variables.html)
* [Usage with Puppet](https://docs.puppetlabs.com/hiera/3.0/puppet.html)
* [Complete Example](https://docs.puppetlabs.com/hiera/3.0/complete_example.html)
* [Usage on the Commandline](https://docs.puppetlabs.com/hiera/3.0/command_line.html)
* [Writing New Backends](https://docs.puppetlabs.com/hiera/3.0/custom_backends.html)
